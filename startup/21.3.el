...
(defconst i-use-nxml                     t "True if I use nxml mode (emacs XML mode).")
(defconst i-use-smtpmail                 t "True if I use smtpmail to send mail.")
...
(when running-x
  (tool-bar-mode 0)
  (setq my-initial-width 100
		my-initial-height 48
		my-default-width 100
		my-default-height 48))
