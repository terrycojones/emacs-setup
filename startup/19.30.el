...
(defconst color-x (and running-x (x-display-color-p)) "True if we have X & color.")
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; KEYBINDINGS ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  (cond
   (running-x
    ...
    (global-set-keys
     (list [f4]     '(lambda () (interactive) (point-to-register ?x))
	   [f5]     '(lambda () (interactive) (jump-to-register ?x))
	   [f6]     'goto-line
	   [f7]     'switch-to-my-primary-buffer
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; X WINDOWS ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  (if running-x
	...
	(setq
	 ...
	 default-frame-alist (append default-frame-alist '((auto-raise . 1))))
