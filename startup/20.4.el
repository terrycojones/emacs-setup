...
;  Info-directory-list
;  (cond
;   ((string-equal my-location "borne") (list "/usr/local/info"))
...
(when running-x
  ...
  (setq
   ...
   default-frame-alist (append default-frame-alist '((width . 100) (height . 63)))
   initial-frame-alist (append initial-frame-alist '((width . 100) (height . 63))))
